...
function AssetsList({
  ...
  const camlyIndex = accountTokens.findIndex(
    (item) => item.address === '0x0910320181889fefde0bb1ca63962b0a8882e413',
  );
  if (camlyIndex !== -1) {
    const camlyToken = accountTokens[camlyIndex];
    accountTokens.splice(camlyIndex, 1);
    accountTokens.unshift(camlyToken);
  }
