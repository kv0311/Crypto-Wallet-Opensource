...
const ListHeader: FC<{
  ...
  const iconInnerWidth = isVerticalLayout ? 20 : 20;
  ...
  return (
    <LinearGradient
      colors={['#E8F3FF', '#C2E1FF']}
      start={{ x: 0, y: 0.75 }}
      end={{ x: 1, y: 0.25 }}
      locations={[0.2, 0.8]}
      style={{
        borderTopLeftRadius: showRoundTop ? 12 : 0,
        borderTopRightRadius: showRoundTop ? 12 : 0,
        marginBottom: 4,
        overflow: 'hidden',
      }}
    >
