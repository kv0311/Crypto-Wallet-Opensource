...
export const swapAndMarketRoutes = [TabRoutes.Swap];
...
export const tabRoutesConfigBaseMap: Record<TabRoutes, TabRouteConfigBase> = {
  ...
  [TabRoutes.Swap]: {
    name: TabRoutes.Swap,
    tabBarIcon: (focused) =>
      focused ? 'ArrowsRightLeftSolid' : 'ArrowsRightLeftOutline',
  ...
  [TabRoutes.NFT]: {
    name: TabRoutes.NFT,
    tabBarIcon: (focused) => (focused ? 'PhotoSolid' : 'PhotoSolid'),
