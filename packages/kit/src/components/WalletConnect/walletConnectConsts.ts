...
export const WALLET_CONNECT_STORAGE_KEY_WALLET_SIDE =
  'camly@walletconnect-wallet-side';
export const WALLET_CONNECT_STORAGE_KEY_DAPP_SIDE =
  'camly@walletconnect-dapp-side';
...
export const ONEKEY_APP_DEEP_LINK_NAME = 'camly-wallet';
export const ONEKEY_APP_DEEP_LINK = `${ONEKEY_APP_DEEP_LINK_NAME}://`; // camly:// will open camly legacy
...
export const WALLET_CONNECT_CLIENT_META = {
  description: 'Connect with Camly Super Wallet',
  ...
  name: `Camly Super Wallet ${platformNameShort}`,
};
