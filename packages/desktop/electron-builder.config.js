...
module.exports = {
  ...
  'protocols': {
    ...
    'schemes': ['camly-wallet', 'wc', 'ethereum'],
  },
  'extraResources': [
    {
  ...
  'mac': {
    ...
    'artifactName': 'Camly Super Wallet-Wallet-${version}-mac-${arch}.${ext}',
    ...
    'extendInfo': {
      'NSCameraUsageDescription':
        'Please allow Camly Super Wallet to use your camera',
    },
  },
  'win': {
    'extraResources': [
    ...
    'icon': 'build/static/images/icons/512x512.png',
    'artifactName': 'Camly Super Wallet-Wallet-${version}-win-${arch}.${ext}',
  ...
  'linux': {
    ...
    'icon': 'build/static/images/icons/512x512.png',
    'artifactName': 'Camly Super Wallet-Wallet-${version}-linux-${arch}.${ext}',
    'executableName': 'camly-wallet',
    'category': 'Utility',
