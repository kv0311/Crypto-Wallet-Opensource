...
function getTxHistories(
  ...
  const request = `${getCovalentApiEndpoint()}/v1/${chainId}/address/${address}/transactions_v3/`;
  return axios
...
async function fetchCovalentHistoryRaw({
  ...
  const url = `${getCovalentApiEndpoint()}/v1/${chainId}/address/${address}/transactions_v3/`;
