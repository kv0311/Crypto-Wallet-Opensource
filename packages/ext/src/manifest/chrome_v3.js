...
module.exports = {
  ...
  //----------------------------------------------
  'key':
    '',
  'commands': {
    '_execute_action': {
      'suggested_key': {
        'default': 'Alt+Shift+O',
  ...
  'oauth2': {
    'client_id':
      '568377431690-846agrrpun6da9sk5icu5kgv0t8l2obv.apps.googleusercontent.com',
