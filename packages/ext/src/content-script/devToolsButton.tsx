const BTN_ID = 'camly-inpage-debug-dev-tools-button';
const BTN_TEXT = 'RELOAD';
const IFRAME_ID = 'camly-inpage-debug-dev-tools-iframe';
...
function injectDevToolsButton() {
  ...
  devToolsButton.title =
    'Reload Camly Super Wallet extension and this site, make injected.js updated.';
  ...
  devToolsButton.addEventListener('click', () => {
    try {
      ...
      console.log('========================================');
      console.log('>>>>>>>> Camly Super Wallet Extension reloading in 3s...');
